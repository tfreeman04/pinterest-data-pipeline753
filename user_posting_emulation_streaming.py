...
def run_infinite_post_data_loop():
    while True:
        ...
        with engine.connect() as connection:
            ...
            send_data_to_stream(url_pin, 'streaming-0eaa2e755d1f-pin', pin_result)
            send_data_to_stream(url_geo, 'streaming-0eaa2e755d1f-geo', geo_result)
            send_data_to_stream(url_user, 'streaming-0eaa2e755d1f-user', user_result)
